...
<Steps>
  ...
  <Step title="Access your staging site">
    Once ready, your staging environment is accessible at the URL shown in the Staging tab — usually `yoursite.wpstratos.dev` or a dedicated staging subdomain. Click **Open Staging WP Admin** for direct one-click access.
  </Step>
</Steps>

...
<Accordion title="How often are backups taken?">
  Your database is backed up **every hour**, and your full site is backed up **once a day**, covering files and database together. You can also trigger a **manual backup** at any time from \*\*Cloud Panel → your site → Backups → Add New \*\*— for example, before making significant changes to your theme or installing a major plugin update.
</Accordion>

...
<Tip>
  None of these steps help if the domain isn't serving a WordPress page in the first place, a non-WP placeholder or a full-site redirect almost always stops caching \+ other functionality from running at all. See [Known Issues](/troubleshooting/known-issues) if that sounds like your setup.
</Tip>

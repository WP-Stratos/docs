...
<Steps>
  ...
  <Step title="Connect your domain">
    ...
    If you point your domain to WP Stratos-managed DNS, leave the optional proxy toggle on individual records switched off. WP Stratos already handles edge caching and DDoS protection at the platform level, and running a second proxy layer on top of that tends to cause more caching headaches than it solves.

...
<AccordionGroup>
  ...
  <Accordion title="Include URLs from llms.txt — Safe if you maintain an llms.txt file">
    If a file exists at `/llms.txt`, the warmer treats it as a curated list of your most important pages and warms those ahead of the general sitemap crawl. Read the callout below before treating this as an SEO feature; it isn't one, at least not for Google.
  </Accordion>

  <Accordion title="Priority Edge — keep top URLs admitted at the Edge — Safe, recommended">

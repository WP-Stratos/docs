---
title: "Configure SMTP Settings in WP Postman"
...
This page walks you through every field on the WP Postman SMTP settings screen and provides provider-specific instructions for the most common email services. Once you save a valid SMTP configuration, all email your WordPress site sends — password resets, order notifications, contact-form submissions — will flow through your chosen provider instead of the server's local mail agent.
...
| **Password** | Your SMTP password or API key. Store this securely — WP Postman encrypts it at rest. |

...
<Note>
  WP Postman is pre-installed and activated on every WP Stratos site. If you deactivate it, it will be automatically reactivated the next time the plugin receives an update.
</Note>

...
To open the DNS manager, log in to the Cloud Panel at [my.wpstratos.com](https://my.wpstratos.com), select your site, click **Domains** in the sidebar, and then click **Manage DNS** next to the domain you want to configure. Before making changes, double check that you've selected the correct domain from the dropdown above the records table, especially if you manage several domains on one account.
